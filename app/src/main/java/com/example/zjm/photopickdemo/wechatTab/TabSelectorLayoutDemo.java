package com.example.zjm.photopickdemo.wechatTab;
...
public class TabSelectorLayoutDemo extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_selector_layout_demo);
        ...
        int pos = mTabSelectorLayout.addTab(TabSelectorLayout.newTab()
                .setNormalDrawable(resources.getDrawable(R.mipmap.ic_tab_contact))
                .setSelectDrawable(resources.getDrawable(R.mipmap.ic_tab_contact_select))
                .setTitle("contact"));
        mFragmentMap.put(pos, new MyFragment(pos));

        pos = mTabSelectorLayout.addTab(TabSelectorLayout.newTab()
                .setNormalDrawable(resources.getDrawable(R.mipmap.ic_tab_moment))
                .setSelectDrawable(resources.getDrawable(R.mipmap.ic_tab_moment_select))
                .setTitle("moment"));
        mFragmentMap.put(pos, new MyFragment(pos));

        pos = mTabSelectorLayout.addTab(TabSelectorLayout.newTab()
                .setNormalDrawable(resources.getDrawable(R.mipmap.ic_tab_msg))
                .setSelectDrawable(resources.getDrawable(R.mipmap.ic_tab_msg_select))
                .setTitle("message"));
        mFragmentMap.put(pos, new MyFragment(pos));

        pos = mTabSelectorLayout.addTab(TabSelectorLayout.newTab()
                .setNormalDrawable(resources.getDrawable(R.mipmap.ic_tab_person))
                .setSelectDrawable(resources.getDrawable(R.mipmap.ic_tab_person_select))
                .setTitle("person"));
        mFragmentMap.put(pos, new MyFragment(pos));
